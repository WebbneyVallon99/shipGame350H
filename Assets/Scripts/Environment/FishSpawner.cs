...
//         if (quirks != null)
//         {
//             quirks.horizontalSpeed = LevelManager.Instance.fishSpeeds[LevelManager.Instance.CurrentLevel];
...
public class FishSpawner : MonoBehaviour
{
    ...
    // ... (StartSpawning, StopSpawning, SpawnLoop methods remain the same) ...
    ...
    private void SpawnFish()
    {
        ...
        if (quirks != null)
        {
            // FIX: Call LevelManager instead of GameManager
            if (LevelManager.Instance != null && LevelManager.Instance.fishSpeeds.Length > LevelManager.Instance.CurrentLevel)
            {
                quirks.horizontalSpeed = LevelManager.Instance.fishSpeeds[LevelManager.Instance.CurrentLevel];
            } else
            {
                quirks.horizontalSpeed = baseFishSpeed;
            }
        }
    }
}